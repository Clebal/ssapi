module.exports = (app) => {
  ...
  const News = require("../services/NoticiaService");
  const Notifications = require("../services/NotificacionService");
  ...
  app.get("/notificacion/test", (req, res) => {
  ...
  app.get("/notificacion/checkKeys", (req, res) => {
  ...
  app.get("/notificacion/registration", (req, res) => {
